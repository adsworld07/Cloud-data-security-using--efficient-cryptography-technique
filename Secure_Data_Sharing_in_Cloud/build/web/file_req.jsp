    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="file_req.jsp"><span>Send Request</span></a></li>
...
<td> <a href="request.jsp?filename=<%=rs.getString("filename")%>&secret_key=<%=rs.getString("secret_key")%>&pname=<%=rs.getString("provider_name")%>"><font style="color: green; font-size: 16px">Send</a></font> </td>
                                        <tr />
                                        <%
