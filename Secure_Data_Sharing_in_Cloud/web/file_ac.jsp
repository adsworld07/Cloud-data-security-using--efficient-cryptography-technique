    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
          ...
          <li class="active"><a href="file_ac.jsp"><span>Download Details</span></a></li>
        ...
        <div class="article">
         ...
         <table border="1" style="text-align: center;margin-left: 0px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 300px; font-size: 16px; color: #0096da">User Name</th>
                                <th style="text-align: center;width: 100px; font-size: 16px; color: #0096da">File Name</th>
                                <th style="text-align: center;width: 100px; font-size: 16px; color: #0096da">Access Time</th>
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        <td style=" font-size: 14px; color: #666464"><%=rs.getString("username")%></td>     
