...
<head>
<title>Data Provider Login Page</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1>SCloud Data Security using Efficient Cryptosystem Technique</h1>
      </div>
      ...
      <div class="menu_nav">
       <ul>
          ...
          <li class="active"><a href="pro.jsp"><span>Data Provider</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <br><h2>Data Provider Login</h2><br>
         <div class="clr"></div>
         <!---Start Body --->
         <img src="images/own.jpg" width="360" height="200" alt="" />
