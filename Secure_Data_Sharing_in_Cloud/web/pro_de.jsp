...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
          ...
          <li class="active"><a href="pro_de.jsp"><span>Data Provider Details</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <br><h2>Data Provider Details</h2><br>
         <div class="clr"></div>
         <!---Start Body --->
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from reg where role='Provider'");
                                        while(rs.next())
